    ...
    return (
        <Box className="page-content__container" maxW="800px" mx="auto" py={10} px={6} bg="white" borderRadius="lg" >
            <VStack align="start" spacing={6}>
                <Heading size="md" color="#005587">Was sind die Developer Network Bundles?</Heading>
                <Text>
                    Die <b>Developer Network Bundles</b> sind eine Sammlung modularer Erweiterungen für die Plattform <b>map.apps</b>&nbsp;
                ...
                <Box bg="gray.50" borderRadius="md" p={4} w="100%">
                    ...
                    Da die Developer Network Bundles durch die Community entwickelt werden, besteht bei Fehlern kein Anspruch auf Standard-Support. Wir unterstützen Sie jedoch gerne bei der Nutzung und Integration der Bundles in Ihre Anwendungen. <br />
                </Box>
            </VStack>
        </Box>
    );
